...
from easyprotocol.base.parse_generic import ParseBase, T
...
valueGenericT = Union[T, Mapping[K, T], MutableSequence[T]]


class ParseFieldListGeneric(
    ParseBase,
    MutableSequence[parseGenericT[K, T]],
    Generic[T, K],
):
    ...
    def get_value(self) -> MutableSequence[parseGenericT[K, T]]:
    ...
    def set_value(
        self,
        value: MutableSequence[ParseBase]
        | Sequence[ParseBase]
        | Sequence[parseGenericT[K, T] | Any]
        | MutableSequence[parseGenericT[K, T] | Any]
        | dict[str, parseGenericT[K, T] | Any]
        | dict[str, ParseBase | Any],
    ) -> None:
    ...
    @property
    def value(self) -> MutableSequence[parseGenericT[K, T]]:
        """Get the parsed value of the field.
    ...
    def value(
        self,
        value: MutableSequence[parseGenericT[K, T]] | MutableSequence[Any] | Any,
    ) -> None:
    ...
    ) -> parseGenericT[K, T] | MutableSequence[parseGenericT[K, T]]:
    ...
    def __setitem__(
        self,
        index: slice,
        value: Iterable[parseGenericT[K, T]] | Iterable[Any],
    ) -> None:
